    ...
    'ITT':
        {
            ...
            "announce": f"{config_settings.tracker_config.ITT_URL}/{config_settings.tracker_config.ITT_PID}"
        }
    ,
    'SIS':
        {
            ...
            "announce":  f"{config_settings.tracker_config.SIS_URL}/{config_settings.tracker_config.SIS_PID}"
        }
