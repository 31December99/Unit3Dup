# -*- coding: utf-8 -*-
from unit3dup.external.torrent.torrent_clients import TransmissionClient, QbittorrentClient, RTorrentClient
...
def main():
    ...
    tracker_name_list = System.get_tracker_name_list(cli=cli, config=config)
    ...
    if cli.upload or cli.folder or (cli.scan and not cli.ftp):
        bot = Bot(
            cli=cli,
