...
from unit3dup.external.igdb.client import IGDBClient
...
class GameManager:
    ...
    def process(self, selected_tracker: str, tracker_name_list: list, tracker_archive: str) -> list[BittorrentData]:
        ...
        for content in self.contents:
            ...
            UserContent.torrent(content=content, tracker_name_list=tracker_name_list, selected_tracker=selected_tracker,
                                this_path=content.torrent_metadata_path)
